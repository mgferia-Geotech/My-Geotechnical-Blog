...
st.warning("En términos estadisticos diríamos que el talud del **Escenario 1 es {texto_ratio} o más veces más propenso a fallar que el talud del Escenario 2**.", icon="⚠️")
